...
def split_and_save(lines_per_chunk,input_file,output_folder):
...
#        chunk = lines[start_idx+2:end_idx]  ### +2 atom num이랑 title 제거
        chunk = lines[start_idx:end_idx]  ### +2 atom num이랑 title 출력
...
output_folder = '/home/kangmg/compchem/multiwfn/sobEDA/sobeda_run/coordinates'

split_and_save(chunk_int, input, output_folder)
